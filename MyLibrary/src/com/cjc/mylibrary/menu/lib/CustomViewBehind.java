...
import com.cjc.mylibrary.menu.lib.SlidingMenu.CanvasTransformer;
/**
 * 
 *****************************************************
 * <hr>
...
public class CustomViewBehind extends ViewGroup {
	...
	public void scrollBehindTo(View content, int x, int y) {
		...
		if (mMode == SlidingMenu.LEFT) {
			...
			mContent.setVisibility(x >= content.getLeft() ? View.GONE
					: View.VISIBLE);
			mSecondaryContent.setVisibility(x <= content.getLeft() ? View.GONE
					: View.VISIBLE);
